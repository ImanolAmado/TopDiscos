...
if($_SERVER["REQUEST_METHOD"]=="POST"){    
    ...
    $_SESSION['registroABorrar'] = $_POST['id_disco'];
}
?>
...
<body>
    ...
    <h5>Interprete: <?php echo $interprete; ?></h5>
    <h5>Fecha publicación: <?php echo $fecha; ?>
    <h5>Ismn: <?php echo $ismn; ?></h5></h5><br>

    <button><a href="todosLosDiscosEdicion.php" style="text-decoration: none; color:black">Cancelar</a></button>  
    <button><a href="borrarDisco.php" style="text-decoration: none; color:black;">Aceptar</a></button><br><br> 
